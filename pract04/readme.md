...
## Применение к исходному изображению Гауссова размытия
...
Оригинал               | 1             |2              | 
:----------------------------------------:|:---------------------------------------:|:--------------------------------------:|
 <img src="orig.jpg" width="700"/>  |  <img src="sh1.jpg" width="700"/>|  <img src="sh2.jpg" width="700"/> |   
 
3               | 4            |5              | 
:----------------------------------------:|:---------------------------------------:|:--------------------------------------:|
 <img src="sh3.jpg" width="700"/>  |  <img src="sh4.jpg" width="700"/>|  <img src="sh5.jpg" width="700"/> |   
 
## Обработка изображения функциями повышающими резкость.
## Первая функция 
