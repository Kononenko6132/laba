...
## Определение цвета изображения с нарушенным цветовым балансом
...
## Корректировка изображения согласно теории Серого мира вручную.
...
```
## Корректировка согласно теории Серого мира при помощи библиотечной функции.
